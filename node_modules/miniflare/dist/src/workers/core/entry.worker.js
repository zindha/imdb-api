...
var entry_worker_default = {
  async fetch(request, env, ctx) {
    ...
    try {
      ...
      return disablePrettyErrorPage || (response = await maybePrettifyError(request, response, env)), response = maybeInjectLiveReload(response, env, ctx), response = ensureAcceptableEncoding(clientAcceptEncoding, response), env[CoreBindings.LOG_REQUESTS] && maybeLogRequest(request, response, env, ctx, startTime), response;
    } catch (e) {
